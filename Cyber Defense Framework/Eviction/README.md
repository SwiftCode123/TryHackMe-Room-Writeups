...
- After the group uses `Spearphishing Link` technique, I think most likely if someone did open the attachments or click on the links, that particular `Email Account` might have been compromised
